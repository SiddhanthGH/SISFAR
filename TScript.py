...
def Simulation(self):
    ...
    while curr_alt >= 0.1 :
        ...
        #Atmos Sim (Huygens data)
        p = 5.6147 * math.exp((-5*(10**(-5)))*curr_alt)
        ...
        curr_angle = dt*((((-(Q*gravity_accel)/bal_coef)*(lift))+(math.cos(curr_angle)*(gravity_accel-((curr_vel**2)/(2574730+curr_alt)))))/curr_vel) + past_angle
        ...
        curr_range = dt*((2574730*curr_vel*math.cos(curr_angle))/(2574730+curr_alt)) + past_range
